...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Mailbox/SendGroupEmails</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <?php
$link = mysql_connect('localhost', 'apollosoftware', 'cois4000Y');
if (!$link) {
    die('Could not connect: ' . mysql_error());
}
if (!mysql_select_db('apollosoftware')) {
    die('Could not select database: ' . mysql_error());
}
$result = mysql_query('SELECT GROUP_CONCAT(`email`) FROM email_contacts');
if (!$result) {
