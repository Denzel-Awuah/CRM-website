...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  && empty ($bio_err))
  {
    ...
    if($stmt = mysqli_prepare($link,$sql)){
      mysqli_stmt_bind_param($stmt,"ssssssisiiiisi", $title, $firstName, $lastName, $workEmail, $workPhone, $workLocation, $institutionID ,
