...
$pcode = $phone = $notes = $leftTrent = $major = $credAchieved = $cumAchieved = $exempt = "";
...
$pcode_err = $phone_err = $notes_err = $leftTrent_err = $major_err = $credAchieved_err = $cumAchieved = $exempt_err = "";
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="col-md-6">
              <?php  echo "<p>Project #".$projectArray[$index][2]." - Status: ".$projectArray[$index][4]."</p>";?>
            </div>
          </div>
          <div class="col-md-4">
            <div class="progress">
          ...
          <div class="col-md-4">
            <div class="dropdown dropup">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?php
                echo '<a class="dropdown-item" href="changeStatus.php?id='.$projectArray[$index][2].'&value=25>25%</a>';
                echo '<a class="dropdown-item" href="changeStatus.php?id='.$projectArray[$index][2].'&value=50>50%</a>';
                echo '<a class="dropdown-item" href="changeStatus.php?id='.$projectArray[$index][2].'&value=90>90%</a>';
                echo '<a class="dropdown-item" href="changeStatus.php?id='.$projectArray[$index][2].'&value=finish>Finished</a>';
                ?>
              </div>
            </div>
          </div>
